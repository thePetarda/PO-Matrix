...
public class MatrixAssertionsTest {
  ...
  @Test
  void testFullInvalidConstructThrowsOnEmpty() {assertThrows(AssertionError.class, () -> full(new double[][]{}));}
...
//    assertThrows(AssertionError.class, () -> m.get(-1, 0));
  ...
  @ParameterizedTest
  @ArgumentsSource(TestMatrixArgumentProvider.class)
  void testGetThrowsOnNegativeColumn(IDoubleMatrix m) {assertThrows(AssertionError.class, () -> m.get(0, -1));}
